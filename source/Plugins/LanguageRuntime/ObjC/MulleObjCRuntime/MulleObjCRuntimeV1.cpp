                                                       ...
                                                       lldb::ProcessSP process_sp)
{
   ...
   m_parent_isa = process_sp->ReadPointerFromMemory( isa + 3 * ptr_size, error);
   ...
   // get name
   lldb::addr_t name_ptr = process_sp->ReadPointerFromMemory( isa + 4 * ptr_size, error);
...
// This gets the class table of the current universe
//

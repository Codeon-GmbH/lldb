...
private:
  ...
  private:
    ...
    public:
      ...
      VTableRegion(MulleObjCVTables *owner, lldb::addr_t header_addr);
  ...
  public:
    MulleObjCVTables(const lldb::ProcessSP &process_sp,
                     const lldb::ModuleSP &objc_module_sp);
  ...
  std::unique_ptr<MulleObjCVTables> m_vtables_ap;
};

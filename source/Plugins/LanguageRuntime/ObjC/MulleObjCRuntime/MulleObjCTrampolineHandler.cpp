...
const char *MulleObjCTrampolineHandler::
...
";
const char *
    MulleObjCTrampolineHandler::g_lookup_implementation_no_stret_function_code =
        "                      \n\
extern \"C\"                                                                                                    \n\
{                                                                                                               \n\
    extern void *class_getMethodImplementation(void *objc_class, void *sel);                                    \n\
...
MulleObjCTrampolineHandler::MulleObjCVTables::VTableRegion::VTableRegion(
    MulleObjCVTables *owner, lldb::addr_t header_addr)
...
void MulleObjCTrampolineHandler::MulleObjCVTables::VTableRegion::SetUpRegion() {
...
bool MulleObjCTrampolineHandler::MulleObjCVTables::VTableRegion::
...
void MulleObjCTrampolineHandler::MulleObjCVTables::VTableRegion::Dump(
    Stream &s) {
...
MulleObjCTrampolineHandler::MulleObjCVTables::MulleObjCVTables(
...
bool MulleObjCTrampolineHandler::MulleObjCVTables::InitializeVTableSymbols() {
...
bool MulleObjCTrampolineHandler::MulleObjCVTables::RefreshTrampolines(
    void *baton, StoppointCallbackContext *context, lldb::user_id_t break_id,
    lldb::user_id_t break_loc_id) {
  MulleObjCVTables *vtable_handler = (MulleObjCVTables *)baton;
...
bool MulleObjCTrampolineHandler::MulleObjCVTables::ReadRegions() {
...
bool MulleObjCTrampolineHandler::MulleObjCVTables::IsAddressInVTables(
...
MulleObjCTrampolineHandler::MulleObjCTrampolineHandler(
  ...
  m_vtables_ap.reset(new MulleObjCVTables(process_sp, m_objc_module_sp));
  if (m_vtables_ap.get())
...
MulleObjCTrampolineHandler::GetStepThroughDispatchPlan(Thread &thread,
    ...
    if (m_vtables_ap.get()) {
      ...
      if (found_it) {
        ...
        this_dispatch.stret_return =
            (flags & MulleObjCVTables::eOBJC_TRAMPOLINE_STRET) ==
            MulleObjCVTables::eOBJC_TRAMPOLINE_STRET;
  ...
  if (found_it) {
    ...
    if (impl_addr != LLDB_INVALID_ADDRESS) {
      ...
      ret_plan_sp.reset(new MulleThreadPlanStepThroughObjCTrampoline(

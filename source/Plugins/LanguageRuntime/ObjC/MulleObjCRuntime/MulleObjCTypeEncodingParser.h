//===-- MulleObjCTypeEncodingParser.h ---------------------------*- C++ -*-===//
//
...
#ifndef liblldb_MulleObjCTypeEncodingParser_h_
#define liblldb_MulleObjCTypeEncodingParser_h_
...
class MulleObjCTypeEncodingParser : public ObjCLanguageRuntime::EncodingToType {
public:
  MulleObjCTypeEncodingParser(ObjCLanguageRuntime &runtime);
  ~MulleObjCTypeEncodingParser() override = default;
...
#endif // liblldb_MulleObjCTypeEncodingParser_h_

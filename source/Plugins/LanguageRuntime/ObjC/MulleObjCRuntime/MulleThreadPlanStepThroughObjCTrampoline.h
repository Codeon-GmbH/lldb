//===-- MulleThreadPlanStepThroughObjCTrampoline.h --------------*- C++ -*-===//
//
...
#ifndef lldb_MulleThreadPlanStepThroughObjCTrampoline_h_
#define lldb_MulleThreadPlanStepThroughObjCTrampoline_h_
...
public:
  ...
  ~MulleThreadPlanStepThroughObjCTrampoline() override;
...
private:
  ...
  MulleObjCTrampolineHandler *m_trampoline_handler; // FIXME - ensure this
...
#endif // lldb_MulleThreadPlanStepThroughObjCTrampoline_h_
